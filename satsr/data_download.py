...
if satellite_name == "Sentinel":
    ...
    output_folder = (
        "/media/ignacio/Datos/datasets/satelites/LandSat_tiles"
    )
    args = {
        "inidate": inidate,
        "enddate": enddate,
    ...
    output_folder = (
        "/media/ignacio/Datos/datasets/satelites/viirs_tiles"
    )
    args = {
        "inidate": inidate,
        "enddate": enddate,
    ...
    output_folder = (
        "/media/ignacio/Datos/datasets/satelites/modis_tiles"
    )
    args = {
        "inidate": inidate,
        "enddate": enddate,
...
sat.download(results=search_results, output_folder=output_folder)
