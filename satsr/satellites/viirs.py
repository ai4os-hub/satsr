...
band_desc = {
    "I1": "375m Surface Reflectance Band I1 (16-bit integer)",
...
def read_bands(
    tile_path, roi_x_y=None, roi_lon_lat=None, max_res=750
):
...
if __name__ == "__main__":
    save_as(
        input_path="/media/ignacio/Datos/datasets/satelites/viirs_tiles/VNP09.A2019021.2142.001.2019035204543.hdf"
    )
